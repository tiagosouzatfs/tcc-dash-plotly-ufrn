...
#cursor.execute("CREATE TABLE tcc(id, discente, id_curso, nome_curso, id_turma, cod_componente, nome_componente, media_final, descricao)")
...
dict_cod_x_nome_disciplina = { "DCA0103":"ANÁLISE DE SINAIS E SISTEMAS", "DCA0100":"MATEMÁTICA DISCRETA", "DCA0105":"TEORIA DE CIRCUITOS", "DCA0118":"PROCESSAMENTO DIGITAL DE SINAIS",
                            ...
                            "DCA1202":"PROGRAMAÇÃO AVANÇADA", "DCA0104":"ARQUITETURA DE COMPUTADORES", "DCA0110":"MODELAGEM E ANÁLISE DE SISTEMAS DINÂMICOS", 
...
for i,j in dict_matric_x_turmas_csv.items():
    ...
    #index = []
    #for i in range(1,len(df_matriculas)+1):
    #    index.append(i)

    #print(index)

    #adicionar a coluna index no dataframe
    #df_matriculas['id'] = index
    #definir a coluna criada id como index do dataframe
    
    #df_matriculas.set_index('id', inplace=True)
    #print(df_matriculas_2021_2)
    ...
    #### Criar um novo df vazio para cada semestre e ajustar o novo df com as novas colunas
    ...
    #gerar uma lista com a mesma quantidade de linhas do df_to_sql para o semestre atual
    ...
    df_to_sql['semestre'] = lista_semestre_atual
    ...
    df_final = pd.concat([df_final, df_to_sql])
